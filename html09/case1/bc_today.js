...
var dataString = thisDate.toLocaleDateString();
var dataHTML = "<h2>" + dataString + "</h2>";
var thisDay = thisDate.getDay();
var eventHTML = getEvent(thisDay);

document.getElementById("unionToday").insertAdjacentHTML("beforeEnd", dataHTML + eventHTML);
